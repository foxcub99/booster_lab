...
from .booster_lab_marl_env_cfg import BoosterLabMarlEnvCfg


class BoosterLabMarlEnv(DirectMARLEnv):
    cfg: BoosterLabMarlEnvCfg

    def __init__(self, cfg: BoosterLabMarlEnvCfg, render_mode: str | None = None, **kwargs):
